...
namespace WebBanHangOnline.Models.Common
{
	public class Filter
	{
		...
		public static string FilterChar(string str)
		{
			...
			// Kiểm tra xem VietNamChar có được khởi tạo chưa
			if (VietNamChar == null || VietNamChar.Length == 0)
			{
				throw new InvalidOperationException("VietNamChar chưa được khởi tạo.");
			}
